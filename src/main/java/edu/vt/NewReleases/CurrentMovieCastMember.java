...
public class CurrentMovieCastMember {
    /*
    =====================================================================
    ...
    /*
    ============================================================
    Class constructor for instantiating a CurrentMovieCastMember
    object to represent a particular movie cast member.
    ============================================================
     */
    public CurrentMovieCastMember(String actorName, String characterName, String actorPhotoFileName) {
