...
public class SearchedMovie {
    ...
    private List<SearchedMovieCastMember> castMembers;

    /*
    ===================================================
    Class constructor for instantiating a SearchedMovie
    object to represent a particular movie.
    ===================================================
     */
    public SearchedMovie(String id, String title, String mpaaRating, String runtime,
            ...
            List<SearchedMovieCastMember> castMembers) {
        this.id = id;
        this.title = title;
    ...
    public List<SearchedMovieCastMember> getCastMembers() {
        return castMembers;
    }

    public void setCastMembers(List<SearchedMovieCastMember> castMembers) {
        this.castMembers = castMembers;
    }
